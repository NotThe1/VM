...
import utilities.hexEdit.HexEditMetrics;
import utilities.hexEdit.HexEditPanelSimple;

public class HexEditPaneSimplelDriver {
	...
	private byte[] source;
	private HexEditPanelSimple hexEditPanel;
	private JSpinner spinnerRows;
	private JLabel lblPlus;
	private JSpinner spinnerPlus;
	private HexEditPanelSimple hexEditPanel_1;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HexEditPaneSimplelDriver window = new HexEditPaneSimplelDriver();
	...
	private void appClose() {
		Preferences myPrefs = Preferences.userNodeForPackage(HexEditPaneSimplelDriver.class);
	...
	public HexEditPaneSimplelDriver() {
		initialize();
		appInit();
	}// Constructor
	...
	private void initialize() {
		...
		frmTemplate.setTitle("HexEditPaneSimplelDriver");
		...
		hexEditPanel = new HexEditPanelSimple();
		...
		hexEditPanel_1 = new HexEditPanelSimple();
